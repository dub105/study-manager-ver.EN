...
function SecLabel({children,style:sx={}}: {children:React.ReactNode;style?:React.CSSProperties}){return(<div style={{display:"flex",alignItems:"center",gap:8,margin:"0 0 16px",fontSize:10,fontWeight:700,color:C.sub,textTransform:"uppercase",letterSpacing:"0.08em",...sx}}>{children}<div style={{flex:1,height:1,background:C.border}}/></div>);}
